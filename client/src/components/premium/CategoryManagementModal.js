...
const CategoryManagementModal = ({ isOpen, categories, menuItems, onClose, onSave }) => {
  ...
  const handleAddCategory = () => {
    ...
    console.log('🔵 CategoryModal: Calling onSave with add action');
    onSave({
      action: 'add',
  ...
  const handleSaveEdit = (oldName) => {
    ...
    console.log('🔵 CategoryModal: Calling onSave with edit action');
    onSave({
      action: 'edit',
      oldName: oldName,
  ...
  const handleDeleteCategory = (categoryName, itemCount) => {
    ...
    console.log('🔵 CategoryModal: Calling onSave with delete action');
    onSave({
      action: 'delete',
