 ...
 * @param {number} tableCount - Number of tables (default 25)
 * @param {string} baseUrl - Base URL for table links
 * @returns {Array} - Array of {tableNumber, url, fullUrl} objects
 */
export function getAllTableUrls(tableCount = 25, baseUrl = 'https://foodzoneduwakot.netlify.app') {
  const tables = [];
