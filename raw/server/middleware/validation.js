...
const validationRules = {
  ...
  createOrder: [
    ...
    body('orderType').isIn(['dine-in', 'delivery']).withMessage('Invalid order type'),
  ...
  createPayment: [
    ...
    body('payment_method').isIn(['cash', 'card', 'phonepe', 'esewa', 'khalti']).withMessage('Invalid payment method'),
