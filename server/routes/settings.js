...
const SECTIONS = [
  ...
  // ====== 2) Localization ======
  {
    ...
    fields: [
      ...
      { key: 'locale.timezone',        label: 'Timezone', type: 'select', default: 'Asia/Kathmandu', public: false,
        options: ['Asia/Kathmandu', 'Asia/Kolkata', 'Asia/Dubai', 'Asia/Singapore', 'Europe/London', 'America/New_York', 'UTC'] },
      { key: 'locale.date_format',     label: 'Date format', type: 'select', default: 'YYYY-MM-DD', public: false,
        options: ['YYYY-MM-DD', 'DD-MM-YYYY', 'DD/MM/YYYY', 'MM/DD/YYYY'] },
      { key: 'locale.time_format',     label: 'Time format', type: 'select', default: '12h',       public: false, options: ['12h', '24h'] },
