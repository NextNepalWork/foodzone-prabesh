...
const SECTIONS = [
  ...
  // ====== 9) Notifications ======
  {
    ...
    fields: [
      ...
      { key: 'notify.email_on_dinein',   label: 'Email on dine-in order',   type: 'bool', default: false },
      { key: 'notify.email_on_takeaway', label: 'Email on takeaway order',  type: 'bool', default: false },
      { key: 'notify.email_on_delivery', label: 'Email on delivery order',  type: 'bool', default: false },
      { key: 'notify.email_on_payment',  label: 'Email on payment received', type: 'bool', default: false },
      { key: 'notify.email_on_booking',  label: 'Email on table booking request', type: 'bool', default: true },
      { key: 'notify.email_on_enquiry',  label: 'Email on general enquiry', type: 'bool', default: true },
