...
DATABASE_URL=postgresql://aasmidhungana@localhost:5432/foodzone_local
...
`;
    ...
    const connectionStrings = [
        'postgresql://aasmidhungana@localhost:5432/postgres',
    ...
    if (!pool) {
        ...
        console.log('   1. Try: createdb foodzone_local');
        console.log('   2. Or set up PostgreSQL authentication');
        console.log('   3. For now, using Railway database connection');
        
        // Use Railway database as fallback
        const railwayEnv = `# Food Zone Database Configuration (Railway)
...
# Restaurant Configuration
RESTAURANT_NAME="Food Zone Local Dev"
RESTAURANT_PHONE="9851234567"
RESTAURANT_ADDRESS="Local Development Environment"
RESTAURANT_LATITUDE=27.6710
RESTAURANT_LONGITUDE=85.4298
...
BASE_DELIVERY_FEE=50
`;
        fs.writeFileSync(path.join(__dirname, '.env'), railwayEnv);
